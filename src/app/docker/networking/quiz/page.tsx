      ...
      <div className="content-area">
        ...
        <div className="container-fluid py-5 px-md-5">
          <div className="page-intro-header mb-5 text-center text-md-start">
            <h1 className="doc-section-title mb-2" style={{ fontSize: '42px' }}>Networking Knowledge Check: Results</h1>
                ...
                >
                  ...
                  <div className="doc-card-body pt-3">
                    ...
                    <div className="doc-alert doc-alert-info mt-3 p-3 rounded">
                      <p className="mb-2 small"><i className="bi bi-info-circle-fill me-2"></i><strong>Explanation:</strong> {q.description}</p>
                      {q.link && (
                        <div className="text-end mt-2">
                          <Link href={q.link} className="btn btn-sm btn-outline-info rounded-pill px-3" style={{ fontSize: '12px' }}>
                            <i className="bi bi-book-half me-1"></i> Review Concept
                          </Link>
                        </div>
                      )}
                    </div>
  ...
  return (
    <div className="content-area">
      ...
      <div className="container-fluid py-5 px-md-5">
        ...
        {/* PAGE HEADER */}
        <div className="page-intro-header mb-5 text-center text-md-start">
          <h1 className="doc-section-title mb-2" style={{ fontSize: '42px' }}>Networking Knowledge Check</h1>
          <p className="text-secondary opacity-75 fs-5 mb-4">
            Test your understanding of Docker Networking, Drivers, and Swarm connectivity.
          </p>
